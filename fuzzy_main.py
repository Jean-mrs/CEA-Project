...
for w in range(1):
    ...
    plt.savefig("/home/jean/Documents/CEA-Project/Output/Gap_" + str(axis_range) + "_Best" + '_Sim' + str(w))
    ...
    plt.savefig("/home/jean/Documents/CEA-Project/Output/Gap_Final_Values:" + str(axis_range) + "_Best" + '_Sim' + str(w))
